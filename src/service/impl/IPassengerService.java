...
public class IPassengerService implements PassengerService {
    ...
    public void cancelTicket() {
        ...
        System.out.println(StatusEnum.TICKET_SUCCESSFULLY_DELETED);
        System.out.println("Money Refunded To Your Balance = " + passenger1.getBalance()+ " AZN");
    }
    public void buyTicket(){
        showFlights();
        long id = InputUtil.getInstance().inputLong("Enter The Flight ID to Buy Ticket:");
        ...
        System.out.println(flight.getPrice() + "AZN - CHARGED FROM YOUR ACCOUNT");
        System.out.println("THANK FOR YOUR ORDER!\nYOUR BALANCE: " + passenger.getBalance() + "AZN");
    }
